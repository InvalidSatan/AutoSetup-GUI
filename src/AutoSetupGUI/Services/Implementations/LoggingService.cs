...
public class LoggingService : ILoggingService
{
    ...
    public async Task InitializeAsync(string serviceTag, string computerName)
    {
        ...
        try
        {
            ...
            _mainLogFile = Path.Combine(_localLogPath, $"UniversityAutoSetup_v2.1.0_{timestamp}.log");
        ...
        try
        {
            if (Directory.Exists(Path.GetPathRoot(networkBasePath)))
            {
                ...
                _networkMainLogFile = Path.Combine(_networkLogPath, $"UniversityAutoSetup_v2.1.0_{timestamp}.log");
        ...
        LogHeader("University Auto Setup v2.1");
